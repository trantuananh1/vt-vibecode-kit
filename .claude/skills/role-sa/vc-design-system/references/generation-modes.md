...
When generating mermaid code blocks, follow Mermaid v11 syntax rules.
...
For `--slides`: recommend invoking the `frontend-design` skill for richer style selection.
Must follow Mermaid v11 syntax for any Mermaid diagrams.
