...
For presentation-grade output, consider invoking the `frontend-design` skill for richer style selection and distinctive font/palette pairing.
...
**AI image generation:** Use Claude's built-in image generation capabilities to generate images for the deck. For any deck over 10 slides, target a minimum of 2–4 images. Priority order:
...
```bash
# Use Claude's built-in image generation capabilities if needed
